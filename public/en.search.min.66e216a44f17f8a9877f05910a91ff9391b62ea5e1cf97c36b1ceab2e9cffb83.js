...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.04c98a51cece61bc7119954a47781175176bff5469025c3510de4818cd63ac07.js',function(){input.required=false;search();});}
